...
BEGIN
    ...
    -- İlk 3 kaydı debug için logla (Supabase Loglarında görünür)
    raise notice 'Başlangıç Tenant ID: %', final_tenant_id;
    ...
    LOOP
        BEGIN
            ...
            -- CASTING Testi (Hata buradaysa yakalamak için)
            -- Numeric dönüşümlerinde hata olabilir
