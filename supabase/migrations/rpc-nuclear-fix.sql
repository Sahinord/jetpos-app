-- 🔥 NUCLEAR IMPORT FIX 🔥
-- 1. Eski bozuk fonksiyonu siler
-- 2. Yedek Dükkan (0000...) oluşturur (Constraint hatası olmasın diye)
-- 3. Yepyeni, Süper Yetkili Import fonksiyonunu kurar.

-- 1. CLEANUP
DROP FUNCTION IF EXISTS bulk_import_products(jsonb, uuid);

-- 2. CREATE BACKUP TENANT
INSERT INTO tenants (id, name, license_key, address)
VALUES ('00000000-0000-0000-0000-000000000000', 'Yedek Depo', 'BACKUP-STORE', 'System')
