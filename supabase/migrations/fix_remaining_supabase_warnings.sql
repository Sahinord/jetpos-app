-- ==============================================================================
-- JETPOS GÜVENLİK VE PERFORMANS YAMASI (Kesin Çözüm - Tüm Kalan Tablolar)
-- ==============================================================================
-- Bu script, gönderdiğin ekran görüntülerindeki TÜM tabloları (audit_logs, 
-- support_tickets, blog_posts vb.) tarar, üzerindeki bütün eski/çakışan kuralları
-- tamamen siler ve yerlerine tek bir tane, en hızlı yeni nesil kuralı kurar.

DO $$ 
DECLARE
    t_name TEXT;
    has_tenant_id BOOLEAN;
    -- Ekran görüntülerinde hata veren tüm tabloların listesi:
...
SELECT 'Ekran görüntüsündeki tüm tablolar temizlendi ve optimize edildi!' as sonuc;
