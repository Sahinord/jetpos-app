    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                backgroundImage: "radial-gradient(circle, rgba(120, 134, 199,0.1) 0%, transparent 70%)",
                filter: "blur(60px)", pointerEvents: "none"
            }} />
            <div style={{
                position: "absolute", bottom: "-10%", right: "-10%", width: "40%", height: "40%",
                backgroundImage: "radial-gradient(circle, rgba(176,186,230,0.1) 0%, transparent 70%)",
                filter: "blur(60px)", pointerEvents: "none"
            }} />
