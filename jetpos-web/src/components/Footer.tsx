                    ...
                    <div>
                        ...
                        <ul style={{ display: "flex", flexDirection: "column", gap: "0.75rem", listStyle: "none" }}>
                            {[
                                ...
                                { label: "Entegrasyonlar", href: "/#contact" },
                            ].map(item => (
                                <li key={item.label}>
                                    <a href={item.href} style={{ color: "rgba(255,255,255,0.5)", fontSize: "0.875rem", textDecoration: "none", transition: "color 0.2s" }}
                ...
                <div style={{ marginTop: "3rem", paddingTop: "2rem", borderTop: "1px solid rgba(255,255,255,0.07)", display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "space-between", gap: "1rem" }}>
                    ...
                    <div style={{ display: "flex", gap: "1.5rem" }}>
                        {[
                            ...
                            <a key={item.label} href={item.href} style={{ color: "rgba(255,255,255,0.35)", fontSize: "0.8125rem", textDecoration: "none", transition: "color 0.2s" }}
