            ...
            <div className="glass-card p-2 mb-3">
                <div className="flex items-center justify-between flex-wrap gap-2">
                    ...
                    <div className="flex items-center gap-2 text-secondary">
                        ...
                        <span className="text-sm font-medium text-white">Alacak Dekontu</span>
                    </div>
                </div>
            </div>
                                        ...
                                        <tr key={kalem.id} className="hover:bg-white/[0.02]">
                                            <td className="px-2 py-1">
                                                <input
                                                    ...
                                                    className="w-full bg-transparent border border-white/10 rounded px-2 py-1 text-white text-xs focus:border-emerald-500 focus:outline-none"
                                                />
                                            </td>
                                            <td className="px-2 py-1">
                                                <input
