...
export default function AppSettings({ theme, setTheme, isBeepEnabled, setIsBeepEnabled, showHelpIcons, setShowHelpIcons, showToast }: any) {
    ...
    return (
        <div className="space-y-8 pb-10">
            {/* Header */}
            <div>
                <h1 className="text-3xl font-black tracking-widest uppercase mb-2">UYGULAMA AYARLARI</h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="glass-card space-y-6">
                    <div className="flex items-center gap-3 border-b border-border pb-4">
                        ...
                        <h2 className="font-black tracking-widest uppercase">GÖRÜNÜM TEMA SEÇİMİ</h2>
                    </div>
                    ...
                    <div className="grid grid-cols-1 gap-3">
                        {themes.map((t) => (
                            <button
                                ...
                                className={`flex items-center justify-between p-4 rounded-2xl border-2 transition-all ${theme === t.id ? 'border-primary bg-primary/5' : 'border-white/5 hover:border-white/10'}`}
                            >
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="glass-card space-y-6">
                    <div className="flex items-center gap-3 border-b border-border pb-4">
                        ...
                        <h2 className="font-black tracking-widest uppercase">SES VE BİLDİRİMLER</h2>
                    </div>
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-between p-4 bg-white/5 rounded-2xl border border-white/5">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <div className="font-black text-sm uppercase tracking-wider">KASA BİP SESİ</div>
                            ...
                            <button
                                ...
                                className={`w-16 h-8 rounded-full relative transition-all duration-300 ${isBeepEnabled ? 'bg-primary' : 'bg-white/10'}`}
                            >
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="glass-card space-y-6">
                    <div className="flex items-center gap-3 border-b border-border pb-4">
                        ...
                        <h2 className="font-black tracking-widest uppercase">SİSTEM VE GÜVENLİK</h2>
                    </div>
                    ...
                    <div className="pt-4 border-t border-border flex flex-col gap-2">
                        <button className="flex items-center justify-center gap-2 py-3 bg-white/5 hover:bg-white/10 rounded-xl text-xs font-black uppercase tracking-widest transition-all">
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="glass-card space-y-6 bg-primary/5 border-primary/20">
                    ...
                    <div className="flex flex-col gap-3">
                        <a href="#" className="flex items-center justify-between p-4 bg-[#0f172a] rounded-2xl border border-white/5 group hover:border-primary/50 transition-all">
                            <span className="text-xs font-black uppercase tracking-widest">Kullanım Klavuzu</span>
