...
// ÜRETİM ADRESİ — app'in yüklediği web deployment'ı.
// NOT: Bu değer build'e gömülür; değişince yeni sürüm build + GitHub release
...
const PROD_URL = 'https://app.jetpos.shop';
let mainWindow;
